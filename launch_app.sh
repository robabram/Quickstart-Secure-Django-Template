...
echo -e "info:    'export PYTHONPATH=\`pwd\`'"
echo -e "info:    'cd django_project'"
echo -e "info:    'python3 manage.py runserver'"
echo -e ""
echo -e "info: to launch uwsgi server run:"
echo -e "info:    'uwsgi --ini django_project/proj/uwsgi.ini'"
echo -e "info: note: see systemd/django-app.service for running uwsgi as a service."
echo -e ""
echo -e "done."